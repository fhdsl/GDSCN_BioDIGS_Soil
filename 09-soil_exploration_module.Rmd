...
You may first need to install the `remotes`` package to your RStudio environment. `remotes` is a package (or chunk of prewritten code) that allows you to download code that has been stored on GitHub into RStudio.
