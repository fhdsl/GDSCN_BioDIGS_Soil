...
```{r, fig.align='center', echo = FALSE, fig.alt= "If the dataset loaded, you will see an object with non-zero observations and variables in the Environment tab.", out.width = '100%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/1u2CIcN2AxprMbWLzAldr_V-njdvjCS8HLYjvuy6jmfs/edit#slide=id.g33497bd5a49_0_9")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "You can click on the object in the Environment tab to open a new window that allows you to scroll through the loaded dataset.", out.width = '100%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/1u2CIcN2AxprMbWLzAldr_V-njdvjCS8HLYjvuy6jmfs/edit#slide=id.g33497bd5a49_0_12")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "The data dictionary shows up under the Help tab.", out.width = '100%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/1u2CIcN2AxprMbWLzAldr_V-njdvjCS8HLYjvuy6jmfs/edit#slide=id.g33497bd5a49_0_15")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "The metadata, or data about the data, opens when you view the soil.meta object.", out.width = '100%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/1u2CIcN2AxprMbWLzAldr_V-njdvjCS8HLYjvuy6jmfs/edit#slide=id.g33497bd5a49_0_21")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "The soil characteristics and metadata have been combined in the soil.combined dataset, which you see if you scroll to the end of the table.", out.width = '100%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/1u2CIcN2AxprMbWLzAldr_V-njdvjCS8HLYjvuy6jmfs/edit#slide=id.g33497bd5a49_0_21")
```
