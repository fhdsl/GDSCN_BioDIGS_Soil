...
We also use the `library` command to load and attach packages to the R environment. When you load a library, you make the functions and objects from a package available for use in your current R session.
