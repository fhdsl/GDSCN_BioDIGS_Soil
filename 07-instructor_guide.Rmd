...
Although AnVIL is the preferred computational platform for the GDSCN, this activity can be run using RStudio on AnVIL, [Posit Cloud](https://posit.cloud/), and local installations of R or RStudio.
